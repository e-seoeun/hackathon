...
* process2
YYYYMMDD_result_raw.csv를 불러온 후 기준날짜와 전날짜 기준 Apparent Angular Velocity, Motion Angle를 계산하고
수직방향 및 수천방향 거리인 D1, D2를 계산하여 최종 결과파일인 YYYYMMDD_result.csv파일을 저장합니다.

* process3
실행 후 원하는 Norad ID를 입력하면 YYYYMMDD_result_raw.csv기반 그래프를 생성합니다.
